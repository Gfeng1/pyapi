...
def main():
    ...
    print(f"The character {got_charToLookup} has the allegiances : {got_dj[0]['allegiances']}")
    pprint.pprint(f"The character {got_charToLookup} is in the books: {got_dj[0]['books']}")
